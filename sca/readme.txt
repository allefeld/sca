...
The original SCA algorithm assumes that there is only one cluster in the data.
...
The code has been developed and tested with MATLAB
<http://www.mathworks.com/products/matlab/> and GNU Octave
<http://www.octave.org>. If you have any problems running the code, please
tell me about it.
